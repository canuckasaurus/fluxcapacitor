...
config :dify, Dify.Mailer, adapter: Swoosh.Adapters.Local

config :dify_web,
  ecto_repos: [Dify.Repo],
  generators: [context_app: :dify, binary_id: true]
...
config :dify_web, DifyWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: DifyWeb.ErrorHTML, json: DifyWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Dify.PubSub,
...
config :esbuild,
  ...
  dify_web: [
    ...
    cd: Path.expand("../apps/dify_web/assets", __DIR__),
...
config :tailwind,
  ...
  dify_web: [
    ...
    cd: Path.expand("../apps/dify_web", __DIR__)
  ]
