defmodule Dify.Accounts.AccountToken do
  use Ecto.Schema
  import Ecto.Query
  alias Dify.Accounts.AccountToken
  ...
  schema "accounts_tokens" do
    ...
    belongs_to :account, Dify.Accounts.Account
  ...
  def build_session_token(account) do
    ...
    dt = account.authenticated_at || NaiveDateTime.utc_now(:second)
